...
local function ShowRushAchievement()
    task.spawn(function()
...
if not getgenv().GotRushAchievement then
    getgenv().GotRushAchievement = true
    ShowRushAchievement()
end
end)
...
v413:Play()
    ...
    task.spawn(function()
        ...
        if frame.Frame.Details:FindFirstChild("Reason") then
            frame.Frame.Details.Reason.Text = ""
