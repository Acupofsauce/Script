if workspace:FindFirstChild("hardcoreInit") then
    ...
    vu4.Text = "硬核重置版V7.5.1"
    function updt()
        game:GetService("RunService").RenderStepped:Wait()
        vu2 = vu2 + 1
        vu4.Text = string.format("加裁硬核重置版V7.5.1... %s / %s", tostring(vu2), tostring(vu1))
    end
    ...
    updt()
    local vu20 = v15("https://github.com/Acupofsauce/Music/blob/fbef6f4138c71b8d44711c55168a2e6deaa027bc/Rebound.mp3", "ReboundMoving")    
    updt()
    ...
    updt()
    vu4.Text = "加裁完毕: " .. tostring(tick() - v3)
