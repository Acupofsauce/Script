...
if workspace:FindFirstChild("hardcoreInit") then
    ...
    function updt()
        ...
        vu2 = vu2 + 1
        vu4.Text = string.format("加裁硬核重置版V7.7... %s / %s", tostring(vu2), tostring(vu1))
    end
    ...
    updt()
    local vu21 = v15("https://github.com/thatstinknoon/ReboundMain/blob/main/ReboundWarning.mp3?raw=true", "Rebound")
    updt()
    ...
    updt()
    vu4.Text = "加裁完毕(请等人，回头，不坑人): " .. tostring(tick() - v3)
    game.Debris:AddItem(vu4, 6)
    local vu31 = {
    ...
    if game.ReplicatedStorage.GameData.LatestRoom.Value <= 1 then
        ...
        delay(0, function()
            ...
            vu43("Hardcore-Remake Initiated")
            task.wait(2)
